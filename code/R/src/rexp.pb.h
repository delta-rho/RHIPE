...
class REXP : public ::google::protobuf::Message {
 public:
  ...
  inline const ::google::protobuf::RepeatedField< double >& realvalue() const
      ;
  inline ::google::protobuf::RepeatedField< double >* mutable_realvalue();
  ...
  inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >& intvalue() const
      ;
  inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >* mutable_intvalue();
  ...
  inline const ::google::protobuf::RepeatedPtrField< ::STRING >& stringvalue() const;
  inline ::google::protobuf::RepeatedPtrField< ::STRING >* mutable_stringvalue();
  ...
  inline const ::google::protobuf::RepeatedPtrField< ::CMPLX >& complexvalue() const;
  inline ::google::protobuf::RepeatedPtrField< ::CMPLX >* mutable_complexvalue();
  ...
  inline const ::google::protobuf::RepeatedPtrField< ::REXP >& rexpvalue() const;
  inline ::google::protobuf::RepeatedPtrField< ::REXP >* mutable_rexpvalue();
  ...
  inline const ::google::protobuf::RepeatedPtrField< ::REXP >& attrvalue() const;
  inline ::google::protobuf::RepeatedPtrField< ::REXP >* mutable_attrvalue();
 ...
 private:
  ...
  static const ::std::string _default_rawvalue_;
...
class STRING : public ::google::protobuf::Message {
 ...
 private:
  ...
  ::std::string* strval_;
  static const ::std::string _default_strval_;
  bool isna_;
  friend void  protobuf_AddDesc_rexp_2eproto();
  friend void protobuf_AssignDesc_rexp_2eproto();
  friend void protobuf_ShutdownFile_rexp_2eproto();
...
inline void REXP::set_rclass(::REXP_RClass value) {
  GOOGLE_DCHECK(::REXP_RClass_IsValid(value));
  _set_bit(0);
  rclass_ = value;
}
...
inline void REXP::set_booleanvalue(int index, ::REXP_RBOOLEAN value) {
  GOOGLE_DCHECK(::REXP_RBOOLEAN_IsValid(value));
