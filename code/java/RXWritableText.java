...
public class RXWritableText  extends BinaryComparable implements RXWritable,WritableComparable<BinaryComparable>{ 
    public void set(REXP v) throws REXPMismatchException{
	set( ((REXPString)v).asString());
    }
    public REXP getREXP() throws IOException{
	try{
	    REXP j = new REXPString(new String[]{toString()});
	    return j;
	}catch(Exception e){
	    throw new IOException(e);
	}
    }
  private static final Log LOG= LogFactory.getLog(RXWritableText.class);
  ...
  public RXWritableText() {
    bytes = EMPTY_BYTES;
  }

  /** Construct from a string. 
   */
  public RXWritableText(String string) {
    set(string);
  }

  /** Construct from another text. */
  public RXWritableText(RXWritableText utf8) {
    set(utf8);
  }

  /** Construct from a byte array.
   */
  public RXWritableText(byte[] utf8)  {
    set(utf8);
  }
  ...
  /** copy a text. */
  public void set(RXWritableText other) {
    set(other.getBytes(), 0, other.getLength());
  }

  /**
   * Set the RXWritableText to range of bytes
  ...
  /*
   * Sets the capacity of this RXWritableText object to <em>at least</em>
   ...
   * than the current capacity, the RXWritableText object's capacity is
   * increased to match.
  ...
  /** Skips over one RXWritableText in the input. */
  ...
  /** Returns true iff <code>o</code> is a RXWritableText with the same contents.  */
  ...
  /** A WritableComparator optimized for RXWritableText keys. */
  public static class Comparator extends WritableComparator {
    public Comparator() {
      super(RXWritableText.class);
    }
  ...
  static {
    ...
    WritableComparator.define(RXWritableText.class, new Comparator());
  }
